...
parser.add_argument('--mx-model',    type=str, default = config.mxnetParam)
parser.add_argument('--mx-epoch',    type=int, default = config.mxnetEpoch)
parser.add_argument('--cf-prototxt', type=str, default = config.caffePrototxt)
parser.add_argument('--cf-model',    type=str, default = config.caffeModel)
