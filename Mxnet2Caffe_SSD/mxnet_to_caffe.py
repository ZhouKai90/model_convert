...
sys.path.append('xx/mxnet/mxnet-1.4.0/example/ssd/tools/caffe_converter')
...
if __name__ == '__main__':  # pragma: no cover
    ...
    parser.add_argument("--caffe_prototxt", dest='caffe_prototxt', type=str, default=None,
                        help="filename of caffe deploy prototxt")
    parser.add_argument("--caffemodel_name", dest='caffemodel_name', type=str, default=None,
